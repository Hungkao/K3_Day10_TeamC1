...
| 2 | Nguyễn Văn Phong | 01087 | Role 2 — Data Eng | `src/ingestion/`, `data/raw/`, `data/clean/` |
| 3 | Nguyễn Hữu Khánh Tùng | 01781 | Role 3 — RAG Specialist | `src/retrieval/`, `data/embeddings/` |
| 4 | Nguyễn Tuấn Vũ | 01845 | Role 4 — Eval & Observability | `src/evaluation/`, `src/observability/` |
